// src/pages/Home/HomePage.tsx - Reddit Style
import { useNavigate } from 'react-router-dom';
import { useState } from 'react';
import { useQuery } from '@tanstack/react-query';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Shield, ArrowUp, ArrowDown, MessageSquare, Share2, Bookmark, Award, ExternalLink, Calendar, Flame, Clock, Star, MoreHorizontal } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <aside className="hidden lg:block lg:col-span-4 space-y-4">
            ...
            {/* Features */}
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200/60 dark:border-gray-800/60 rounded-2xl p-4 shadow-sm">
              <h3 className="font-bold text-gray-900 dark:text-white mb-3">🎉 Reddit-Style Features</h3>
